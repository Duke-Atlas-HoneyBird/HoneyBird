...
- [x] 1. Set up theme and styling foundation
...
- [x] 2. Create core reusable widgets

- [x] 2.2 Implement SearchBarWidget
...
- [x] 2.3 Implement PostCard widget
...
- [x] 2.4 Implement BottomNavigationWidget
...
- [x] 2.5 Implement SideMenuDrawer
...
- [x] 3. Implement PostFeedWidget with state management
  ...
  - Ensure feed occupies ~40% of screen height
  - _Requirements: 2.1, 2.2, 2.3, 2.8_

- [x] 4. Implement HomeScreen
- [x] 4.1 Create HomeScreen structure
...
- [x] 4.2 Implement HomeScreen state management
...
- [x] 4.3 Wire up navigation and interactions
...
- [x] 5. Implement placeholder screens for navigation
- [x] 5.1 Create FavoritesScreen
...
- [x] 5.4 Create side menu screens
...
- [x] 6. Implement PostCreationScreen
- [x] 6.1 Create PostCreationScreen UI
...
- [x] 6.2 Implement post creation logic
...
- [x] 7. Update main.dart and wire everything together
