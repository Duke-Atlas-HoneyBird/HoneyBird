...
class _$MessagesStateImpl implements _MessagesState {
  ...
  @override
  String toString() {
    return 'MessagesState(isLoading: $isLoading, conversations: $conversations, unreadCount: $unreadCount, messages: $messages, conversationId: $conversationId, errorMessage: $errorMessage)';
  }
...
abstract class _MessagesState implements MessagesState {
  const factory _MessagesState(
      ...
      final String conversationId,
      final String? errorMessage}) = _$MessagesStateImpl;
