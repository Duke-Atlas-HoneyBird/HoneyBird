...
class _$CommentStateImpl implements _CommentState {
  ...
  @override
  String toString() {
    return 'CommentState(isLoading: $isLoading, postId: $postId, comments: $comments, errorMessage: $errorMessage)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, postId,
...
abstract class _CommentState implements CommentState {
  const factory _CommentState(
      ...
      final String? errorMessage}) = _$CommentStateImpl;
